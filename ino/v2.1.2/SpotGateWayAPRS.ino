/*
   APRS BALISE Station and SpotGen3 Satelite Tracker GlobalStar GateWay Ver 2.1.2
...
String SpotToken = "your api token";     //your Spot API Token
String SpotComment = "https://maps.findmespot.com/s/....";  //ex: your share map link from findmespot
// EX: https://api.findmespot.com/spot-main-web/consumer/rest-api/2.0/public/feed/**your api token**/latest.json
...
String SpotSymbol = "D";              //APRS icon selection   
...
String Comment = "https://github.com/RealDrouin";     //your comment
...
String password = "your password";  //your wifi password
  ...
  if (client.connect("rotate.aprs2.net", 14580)) {
    ...
    while (client.available()) {
      ...
      if (response.indexOf("verified") > 0) {
        if (AprsBroadcast == true and FindMeSpotBroadcast == false) {
          broadcastCount++;
          client.println((CallSign) + ">APRS,TCPIP:>APRS Balise & Spot GateWay by VE2CUZ " + (ver.c_str()));
          Serial.println((CallSign) + ">APRS,TCPIP:>APRS Balise & Spot GateWay by VE2CUZ " + (ver.c_str()));
